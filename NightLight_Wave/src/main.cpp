...
pa_activity (Synchronizer, pa_ctx(Input accu), bool sync, const PressSignal& press, bool gesture_enabled, const PressSignal& up_press, const PressSignal& down_press, InputSignal& input) {
  pa_always {
    if (gesture_enabled) {
...
pa_activity (Main, pa_ctx(pa_co_res(10); pa_signal_res;
